...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Chat.ChatRequest,
      Chat.ChatResponse> getProcessMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ProcessMessage",
      requestType = Chat.ChatRequest.class,
      responseType = Chat.ChatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Chat.ChatRequest,
      Chat.ChatResponse> getProcessMessageMethod() {
    io.grpc.MethodDescriptor<Chat.ChatRequest, Chat.ChatResponse> getProcessMessageMethod;
    if ((getProcessMessageMethod = ChatServiceGrpc.getProcessMessageMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getProcessMessageMethod = ChatServiceGrpc.getProcessMessageMethod) == null) {
          ChatServiceGrpc.getProcessMessageMethod = getProcessMessageMethod =
              io.grpc.MethodDescriptor.<Chat.ChatRequest, Chat.ChatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ProcessMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Chat.ChatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Chat.ChatResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ChatServiceMethodDescriptorSupplier("ProcessMessage"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void processMessage(Chat.ChatRequest request,
        io.grpc.stub.StreamObserver<Chat.ChatResponse> responseObserver) {
  ...
  public static final class ChatServiceStub
    ...
    /**
     */
    public void processMessage(Chat.ChatRequest request,
        io.grpc.stub.StreamObserver<Chat.ChatResponse> responseObserver) {
  ...
  public static final class ChatServiceBlockingStub
    ...
    /**
     */
    public Chat.ChatResponse processMessage(Chat.ChatRequest request) {
  ...
  public static final class ChatServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Chat.ChatResponse> processMessage(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_MESSAGE:
          serviceImpl.processMessage((Chat.ChatRequest) request,
              (io.grpc.stub.StreamObserver<Chat.ChatResponse>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              Chat.ChatRequest,
              Chat.ChatResponse>(
                service, METHODID_PROCESS_MESSAGE)))
        .build();
  }
